...
InitializeVarsPrecaches()
{
    ...
    level._UpgSMGNames = StrTok("Nuevemuertes xx,Stellar 92,Sky Scorcher,Corpsemaker,Ghoul Keepers Subjucator,PieceDerResistance,Unseen VHand,Excisenin3fold,The Dark Impaler,Infernal Mercy,The Afterburner,SpeakEasy",",");
    ...
    level._UpgPistolNames = StrTok("Rapskallion 3D,Belle Of The Ball,Z-Harmony,King & Country,IM-PAK-D", ",");
    ...
    level._UpgBloodWeaps = StrTok("ww_blundergat_fire_t8_upgraded,ww_blundergat_acid_t8_upgraded,ww_blundergat_t8_upgraded,tomahawk_t8_upgraded,zhield_spectral_dw_upgraded,spknifeork,golden_knife,ww_blundergat_fire_t8_unfinished", ",");
    level._UpgBloodNames = StrTok("Magnus Operandi,Vitriolic Withering,The Sweeper,Hells Redeemer,Attuned Spectral Shield,Golden Spork Knife,Golden Scalpel,Tempered Blundergat", ",");
    ...
    level._DeadWeaps = StrTok("ww_crossbow_impaler_t8,ww_random_ray_gun1,stake_knife,zhield_dw",",");
    level._DeadUpgWeaps = StrTok("ww_random_ray_gun2,ww_random_ray_gun3", ",");
    level._DeadUpgNames = StrTok("Chaos Theory,Alistairs Annihilator", ",");
    level._DeadWeapNames = StrTok("Savage Impaler,Alistairs Folly,Stake Knife,Ballistic Shield",",");
    ...
    level._UpgTagWeaps = StrTok("thundergun_upgraded,ww_tesla_gun_t8_upgraded,ww_tesla_sniper_upgraded_t8,tundragun_upgraded,snowball_upgraded,snowball_yellow_upgraded",",");
    level._UpgTagWeapNames = StrTok("Zeus cannon,Wonderwaffe DG-3 JZ,Wunderwaffe DG-Funkenschutze,Boreas Blizzard,snowball upgraded,snowball yellow upgraded", ",");
    level._AOWeaps = StrTok("ray_gun_mk2v,ray_gun_mk2x,ray_gun_mk2y,ray_gun_mk2z,galvaknuckles_t8,zhield_dw",",");
    level._UpgAOWeaps = StrTok("ray_gun_mk2v_upgraded,ray_gun_mk2x_dw,ray_gun_mk2y_upgraded,ray_gun_mk2z_upgraded,galvaknuckles_t8,zhield_dw",",");
    level._AOWeapNames = StrTok("Ray Gun II-V,Ray Gun II-X,Ray Gun II-Y,Ray Gun II-Z,Galvaknuckles,Ballistic Shield",",");
    level._ClassWeaps = StrTok("ww_Freezegun_t8,zhield_dw",",");
    level._ClassWeapNames = StrTok("Winters Howl,Ballistic Shield",",");
    level._UpgClassWeaps = StrTok("ww_Freezegun_t8,zhield_dw",",");
    level._UpgClassWeapNames = StrTok("Winter's Fury", ",");
    level._MapWeapsAether = StrTok("ray_gun,ray_gun_mk2,cymbal_monkey",",");
